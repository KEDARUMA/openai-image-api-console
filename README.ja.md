...
以下は OpenAI 公式ドキュメント上で画像生成・画像編集に使えそうなモデルの整理です。`✅` は対応、`❌` は非対応、`❓` は要確認を示します。

| モデル ID | 系統 | Text / Image to Image | Edit with Mask | アプリで使用可 | アルファチャンネル対応 | 価格 |
|---|---|---|---|---|---|---|
| `gpt-image-2` | GPT Image 2 | ✅ | ✅ | ✅ | マスク alpha: ✅ / 透明背景: ❌ | Image: input $8.00 / cached $2.00 / output $30.00、Text: input $5.00 / cached $1.25 |
| `gpt-image-1.5` | GPT Image 1.5 | ✅ | ✅ | ✅ | マスク alpha: ✅ / 透明背景: ❓ | Image: input $8.00 / cached $2.00 / output $32.00、Text: input $5.00 / cached $1.25 / output $10.00 |
| `gpt-image-1` | GPT Image 1 | ✅ | ✅ | ✅ | マスク alpha: ✅ / 透明背景: ❓ | アプリ表示: input $10.00 / output $40.00 |
| `gpt-image-1-mini` | GPT Image 1 mini | ✅ | ✅ | ✅ | マスク alpha: ✅ / 透明背景: ❓ | Image: input $2.50 / cached $0.25 / output $8.00、Text: input $2.00 / cached $0.20 |
